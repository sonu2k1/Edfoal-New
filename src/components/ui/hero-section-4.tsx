...
export function HeroSection({
    ...
    return (
        <>
            {showNavbar && <HeroHeader />}
            <div className="overflow-x-hidden" style={{margin:"2rem"}}>
                <section>
                    <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44">
                        <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:w-1/2 lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl font-medium md:text-6xl lg:mt-16 xl:text-7xl text-white leading-tight">
                                    {title}
                                </h1>
                                ...
                                <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
                                    ...
                                    <Button
                                        ...
                                        size="lg"
                                        variant="ghost"
                                        className="px-5 text-base text-zinc-400 hover:text-white">
                ...
                <section className="bg-background pb-16 md:pb-32">
                    <div className="group relative m-auto max-w-6xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            <div className="md:max-w-44 md:border-r md:pr-6 border-zinc-800">
                                <p className="text-end text-sm text-zinc-400">Powering the best teams</p>
                            </div>
    ...
    return (
        <header>
            <nav
                ...
                className="group bg-black/50 fixed top-0 left-0 z-50 w-full border-b border-zinc-800/50 backdrop-blur-3xl">
                <div className="mx-auto max-w-6xl px-6 transition-all duration-300">
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        ...
                        <div className="bg-black/95 group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-zinc-800 p-6 shadow-2xl shadow-zinc-900/50 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none">
